...
public abstract class Posit extends Number implements Comparable<Posit>  {
	...
	/**
	 * From java.lang.Long
	 * Returns a Posit object holding the value of the specified String. The 
	 * argument is interpreted as representing a Posit, exactly as if the argument
	 * were given to the parsePosit(java.lang.String) method. The result
	 * is a Posit object that represents the integer value specified by the string.
	 * <p>
	 * In other words, this method returns a Long object equal to the value of:
	 * new Post(Posit.parsePosit(s))
	 */ 
    /**
     ...
     * {@code s}.
     * ....
     * <Extremely long comment on regex for Flaots> 
     *
     ...
     * ASCII minus sign '-' (\u002D') to indicate a negative value or an ASCII plus 
     * sign '+' ('\u002B') to indicate a positive value. The resulting long value is 
     * returned, exactly as if the argument and the radix 10 were given as arguments
     * to the parseLong(java.lang.String, int) method.
     * <p>
     * Note that neither the character L ('\u004C') nor l ('\u006C') is permitted 
     * to appear at the end of the string as a type indicator, as would be permitted
