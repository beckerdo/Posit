...
public class PositDomainTest {
    ...
    public static final double[] EXPECTED_FIVEBIT_ES1 = {
            0.0, 1.0 / 64.0, 1.0 / 16.0, 1.0 / 8.0, 1.0 / 4.0, 1.0 / 3.0, 1.0 / 2.0, 1.0 / 1.5,
            1.0, 1.5, 2.0, 3.0, 4.0, 8.0, 16.0, 64.0,
            Double.POSITIVE_INFINITY, -64.0, -16.0, -8.0, -4.0, -3.0, -2.0, -1.5,
            -1.0, -1.0 / 1.5, -1.0 / 2.0, -1.0 / 3.0, -1.0 / 4.0, -1.0 / 8.0, -1.0 / 16.0, -1.0 / 64.0 };
    ...
    public void fiveBitES0() {
        ...
        for (int i = 0; i < EXPECTED_FIVEBIT_ES0.length; i++) {
            ...
            // assertEquals(EXPECTED_FIVEBIT_ES0[i], p.doubleValue(),
    ...
    public void fiveBitES1() {
        ...
        for (int i = 0; i < EXPECTED_FIVEBIT_ES1.length; i++) {
            ...
            // assertEquals(EXPECTED_FIVEBIT_ES1[i], p.doubleValue(),
            // PositDomainTest.COMPARE_PRECISION);
        }
        System.out.println("Out of spec count=" + oosCount + "/" + EXPECTED_FIVEBIT_ES1.length + ".");
    }
    ...
    public void sevenBitES1() {
        ...
        for (int i = 0; i < EXPECTED_SEVENBIT_ES1.length; i++) {
            ...
            System.out.println("i=" + i + ", posit=" + PositDomain.toDetailsString(instance, 1) + ",exp="
                    + EXPECTED_SEVENBIT_ES1[i] + outOfSpec);
